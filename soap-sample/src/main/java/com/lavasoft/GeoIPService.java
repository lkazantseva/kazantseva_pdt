 ...
 * 2021-06-16T12:25:30.082+07:00
 * Generated source version: 3.4.4
 *
 */
@WebServiceClient(name = "GeoIPService",
                  wsdlLocation = "C:/kazantseva_pdt/soap-sample/src/main/resources/ipservice.wsdl",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = GeoIPService.class.getResource("C:/kazantseva_pdt/soap-sample/src/main/resources/ipservice.wsdl");
        if (url == null) {
            url = GeoIPService.class.getClassLoader().getResource("C:/kazantseva_pdt/soap-sample/src/main/resources/ipservice.wsdl");
        }
        if (url == null) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "C:/kazantseva_pdt/soap-sample/src/main/resources/ipservice.wsdl");
        }
        WSDL_LOCATION = url;
    }
